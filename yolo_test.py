...
#        file.write('find  '+str(len(out_boxes))+' target(s) \n')
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            # 写入检测位置
            file.write(predicted_class+' '+str(round(score,2))+' '+str(left)+' '+str(top)+' '+str(right)+' '+str(bottom)+'\n')
...
if __name__ == '__main__':
    ...
    for filename in os.listdir(path):        
        ...
        file.write('\n')
        #r_image.show() 显示检测结果
        image_save_path = './out_images/result_'+portion[1]
